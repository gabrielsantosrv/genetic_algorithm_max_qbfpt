...
public class QBFPT implements Evaluator<Integer> {
	...
	/**
	 * A main method for testing the QBFPT class.
	 * 
	 * @param args
	 * @throws IOException
	 */
	public static void main(String[] args) throws IOException {
		...
		QBFPT QBFPT = new QBFPT("instances/qbf040");
		QBFPT.printMatrix();
		Double maxVal = Double.NEGATIVE_INFINITY;
		
//		System.out.println("maxVal = " + QBFPT.evaluateQBF());
//		System.out.println("size = " + QBFPT.variables.length);
//		System.exit(0);
		...
		for (int i = 0; i < 10000; i++) {
			for (int j = 0; j < QBFPT.size; j++) {
				if (Math.random() < 0.5)
					QBFPT.variables[j] = 0.0;
				else
					QBFPT.variables[j] = 1.0;
			}
			System.out.println("x = " + Arrays.toString(QBFPT.variables));
			Double eval = QBFPT.evaluateQBF();
		...
		System.out.println("x = " + Arrays.toString(QBFPT.variables));
		System.out.println("f(x) = " + QBFPT.evaluateQBF());
